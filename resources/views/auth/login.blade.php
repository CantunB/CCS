...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>CCS Administracion Local</title>
    ...
    <body class="loading authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Ingresa tu correo electronico y contraseña para acceder.</p>
                                </div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" name="email" required="" autofocus placeholder="{{ __('E-Mail Address') }}">
                                        @error('email')
        ...
        <footer class="footer footer-alt">
            2020 - <script>document.write(new Date().getFullYear())</script> &copy;<a href="" class="text-white-50">Bernabe Cantun Dominguez</a>
        </footer>
